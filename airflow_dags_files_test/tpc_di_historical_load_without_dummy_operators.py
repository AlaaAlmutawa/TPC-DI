...
with DAG('tpc_di_historical_load_v2.2.1', schedule_interval=None, default_args=default_args) as dag:
...
[prep_partition_daily_market_staging,load_date_to_master,financial_to_master,transform_dimsecurity_to_master] >> transform_factmarkethistory_to_master #>> factmarkethistory_to_master_complete
