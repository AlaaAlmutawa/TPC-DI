...
with DAG('tpc_di_historical_load_v2', schedule_interval=None, default_args=default_args) as dag:
    ...
    transform_factmarkethistory_to_master = insert_overwrite(task_id='transform_factmarkethistory_to_master',
                                                sql_file_path='queries_test/master_populate_factmarkethistory_dag.sql',
...
## populate dimbroker 
[staging_hr_table_creation_complete, reference_date_data_loading_complete] >> transform_hr_to_dimbroker >> dimbroker_to_master_complete

## create cmp, fin, sec 
finwire_load_complete >> transform_finwire_to_cmp >> finwire_cmp_transform_complete
finwire_load_complete >> transform_finwire_to_fin >> finwire_fin_transform_complete
finwire_load_complete >> transform_finwire_to_sec >> finwire_sec_transform_complete

# build DimCompany 
[reference_industry_status_data_loading_complete, finwire_cmp_transform_complete] >> transform_DimCompany_to_master >> dimcompany_to_master_complete

# build finanical ref table
[dimcompany_to_master_complete, finwire_fin_transform_complete] >> financial_to_master >> financial_to_master_complete

# build dimsecurity 
[finwire_sec_transform_complete, dimcompany_to_master_complete] >> transform_dimsecurity_to_master >> dimsecurity_to_master_complete

# build dimcustomer 
[staging_prospect_table_creation_complete, customer_historical_complete, tax_rate_data_loading_complete] >> transform_dimcustomer_to_master >> dimcustomer_to_master_complete

# build dimaccount
[dimcustomer_to_master_complete, dimbroker_to_master_complete] >> transform_dimaccount_to_master >> dimaccount_to_master_complete

#build dimtrade 
[staging_trade_table_creation_complete, reference_time_trade_type_data_loading_complete, reference_date_data_loading_complete, dimaccount_to_master_complete, dimsecurity_to_master_complete] >> transform_dimtrade_to_master >> dimtrade_to_master_complete

# build prospect 
[staging_prospect_table_creation_complete, customer_historical_complete, reference_date_data_loading_complete, staging_batch_date_table_creation_complete] >>  transform_propspect_to_master >> prospect_to_master_complete

# build fact tables 

# build FastCashBalances 
[staging_cash_transaction_table_creation_complete, dimaccount_to_master_complete] >> transform_fastcasbalances_to_master >> fastcashbalances_to_master_complete

# build factwatches 
[staging_watch_history_table_creation_complete, dimcustomer_to_master_complete, dimsecurity_to_master_complete, reference_date_data_loading_complete] >> transform_factwatches_to_master >> fastwatches_to_master_complete

# build FactDailyMarket 
[staging_daily_market_v2_table_creation_complete,reference_date_data_loading_complete,financial_to_master_complete,dimsecurity_to_master_complete] >> transform_factmarkethistory_to_master >> factmarkethistory_to_master_complete

# build FactHolding 
[staging_holding_history_table_creation_complete, dimtrade_to_master_complete] >> transform_factholdings_to_master >> factholdings_to_master_complete 

# Populating DiMessages 
[factholdings_to_master_complete, factmarkethistory_to_master_complete] >> populate_dimessages_in_master >> dimessages_to_master_complete
